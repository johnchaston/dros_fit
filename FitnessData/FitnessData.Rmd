...
## Figure 1
### Figure 1A 
```{r Figure_1A, exercise=F, warning = F, message = F}
...
### Figure 1B
```{r Figure_1B, exercise=F, warning = F, message = F}
...
### Figure 1D
```{r Figure_1D, exercise=F, warning = F, message = F}
...
### Figure 2BD
```{r Figure_2BD, exercise = F, warning =F, message = F, exercise.timelimit = 1000}
...
```{r Figure_3A_Acetobacter, exercise = F, warning =F, message = F}
...
### Figure 3A E. coli
```{r Figure_3A_ecoli, exercise = F, warning =F, message = F}
...
```{r Figure_3B_Acetobacter, exercise = F, warning =F, message = F}
...
### Figure 3B E. coli
```{r Figure_3B_ecoli, exercise = F, warning =F, message = F}
...
```{r Figure_3C_Acetobacter, exercise = F, warning =F, message = F}
...
```
#### Figure 3C E. coli
```{r Figure_3C_ecoli, exercise = F, warning =F, message = F}
...
```{r Figure_3D_Acetobacter, exercise = F, warning =F, message = F}
q = 2
...
#### Figure 3D E. coli
```{r Figure_3D_ecoli, exercise = F, warning =F, message = F}
q = 3
xgroup = unlist(p$group[q])
subset_vec = unlist(unname(p$vec[q]))
rangevals <- c(1)
...
##  Figure S1
```{r Figure_S1, exercise = F, warning =F, message = F, eval = F, exercise.timelimit = 1000}
p <- list(vec = list(vec_bac = c("28n","30p","11c","Gno","4d","35u","Ax","2b","13g","15h","75o","3c","1a","70j","71k"),
                                vec_atmut = c("SDR","PVEC","GDH","GNDH"),
                                vec_ecmut = c("7636","10862")
                                ),
...
## Figure S2
```{r Figure_S2, exercise = F, warning =F, message = F, exercise.timelimit = 1000}
...
## Figure S3
```{r Figure_S3, exercise = F, warning =F, message = F, exercise.timelimit = 1000}
...
## Figure S4
```{r Figure_S4, exercise = F, warning =F, message = F, exercise.timelimit = 1000,eval = T}
q = 1
...
## Figure S5
### Figure S5A
```{r Figure_S5ac, exercise = F, warning =F, message = F, exercise.timelimit = 1000}
...
### Figure S5B
```{r Figure_S5ec, exercise = F, warning =F, message = F, exercise.timelimit = 1000}
q=3
  xgroup = unlist(p$group[q])
  subset_vec = unlist(unname(p$vec[q]))
  rangevals <- c(1, .5,.1,.05, .01, 0.005,.001,.0005,0.0001,0.00001)
...
## MGWA
```{r MGWA, exercise = F, warning =F, message = F, exercise.timelimit = 10000}
